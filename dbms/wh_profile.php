                  ...
                  for($count=0;$count<3;$count++){
                    ...
                    <div class='col-sm-4'>
                      <div style='margin-top:20px' class='thumbnail text-center bg-grey'>
                        ...
                        <img src=".$row['c_image']." alt='crop image' width='200px' height='300px'>
          ...
          if(isset($_POST["buy"])){
              if($_SERVER["REQUEST_METHOD"] == "POST"){
                ...
                if($result["quantity"]>=$qty){
                  ...
                  $date = date("Y-m-d");
                  $new = "INSERT INTO sell_crop VALUES('$result[Farmer_id]','$_SESSION[id]','$c_id','$cost',CURDATE(),'$qty')";
              ...
              ?><script>window.location="wh_profile.php";</script><?php
          }?>
         </div>
