...
<div class="jumbotron text-center">
  ...
  <?php
      if(isset($_SESSION["loggedin"])=== true){
        echo"<a href='log_out.php' role='button' class='btn btn-link btn-lg'>LogOut</a>";
 }
 else{
  echo"<a href='log_in.php' role='button' class='btn btn-link btn-info btn-lg'>LogIn</a>&nbsp;&nbsp;";
  echo"<a href='sign_up.php' role='button' class='btn btn-link btn-info btn-lg'>SignUp</a>";}
?>
</div>
...
<div id="contact" class="container-fluid bg-grey">
  ...
  <div class="row">
    <div class="col-sm-5">
      ...
      <p><span class="glyphicon glyphicon-phone"></span> +91 9265533619</p>
      <p><span class="glyphicon glyphicon-envelope"></span> agrocenter@gmail.com</p>
    </div>
